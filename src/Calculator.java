//Создать класс Calculator с полями weight, cost, color и заполнить их.
// И методами нахождения суммы, разности, деления, умножения двух чисел.
// Метод main в этом классе не создавать
//Создать конструктор для класса Calculator чтобы иметь возможность инициализировать поля в момент создания объекта.
// Так-же в логическом блоке добавить вывод в консоль что создаётся объект Calculator.
